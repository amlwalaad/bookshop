...
from .views import form_reg, display_home, detailsbookview, allstudensview, shoppingcartview, addbook ,mybooks ,updatebook,delete
...
urlpatterns = [
    ...
    path('mybooks/', mybooks, name="shoppingcart"),
    path('mybooks/<int:book_id>/', shoppingcartview),
